...
class MADDPG:
    def __init__(self, discount_factor=0.95, tau=0.02):
        ...
        self.maddpg_agent = [DDPGAgent(14, 128, 128, 2, 20, 128, 128, lr_actor=5.0e-3, lr_critic=5.0e-3), 
                             DDPGAgent(14, 128, 128, 2, 20, 128, 128, lr_actor=5.0e-3, lr_critic=5.0e-3), 
                             DDPGAgent(14, 128, 128, 2, 20, 128, 128, lr_actor=5.0e-3, lr_critic=5.0e-3)]
